// Generated on 2014-10-06 using generator-jekyllized 0.6.0
'use strict';
...
// Compiles the SASS files and moves them into the 'public/css' directory
gulp.task('styles', function () {
    // Looks at the style.scss file for what to include and creates a style.css file
    return gulp.src('src/public/_scss/style.scss')
        .pipe($.rubySass({
          sourcemapPath: ['./src/public/_scss/'],
...
gulp.task('html', ['styles'], function () {
    return gulp.src('serve/**/*.html')
        .pipe($.useref.public({searchPath: 'serve'}))
...
gulp.task('copy', function () {
    ...
    var images = gulp.src('src/public/images/**/*')
        .pipe(gulp.dest('site/public/images'));
...
gulp.task('serve:dev', function () {
    ...
    gulp.watch(['src/**/*.md','src/*.html', 'src/**/*.html'], ['jekyll:dev']);
    gulp.watch(['serve/**/*.html', 'serve/**/*.css', 'serve/**/*.js'], reload);
    gulp.watch(['src/public/_scss/**/*.scss'], ['styles']);
});
